...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  mutate(died, deathStep) {
    ...
    for (var i = 0; i< this.directions.length; i++) {
      ...
      if (rand < mutationRate) { //If the random number is smaller than the mutation rate # then it mutates the current direction to a new one, this happens for all of the steps the player takes.
  ...
  //---------------------------------------------------------------------------------------------------------------------------------------------------------
  //increases the number of elements in directions by 5 this number changes when clicking on the HTML button
 increaseMoves() {
